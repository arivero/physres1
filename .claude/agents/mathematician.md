...
3. Claim a task via TaskUpdate (set owner to "mathematician")
4. Work the task: read sources, verify proofs, write to blackboards/notebooks
5. When done: write results to `proposals/mathematician-<topic>.md`, mark task completed
