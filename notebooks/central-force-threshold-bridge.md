...
1. Readability-only C-cycle gate:
   - compression gain >= 40%,
...
## Entry 2026-02-14 (S275 Iteration 5 stabilization)
...
## Entry 2026-02-14 (S276 Iteration 3 stabilization)
...
## Entry 2026-02-14 (D22 Iteration 3 stabilization)
...
## Entry 2026-02-14 (S277 Iteration 3 stabilization)
...
## Entry 2026-02-14 (S278 Iteration 3 stabilization)
...
## Entry 2026-02-14 (D21 Iteration 4 stabilization)
### Integrated C300 readiness matrix
Readiness criteria are now complete across branches, but the decision policy is unchanged:
- if readability priority is not explicitly active, keep `C300` deferred.
- if readability priority is active, use `D4plus` with existing window/regime caveats available as safeguards.

## Entry 2026-02-14 (S275 Iteration 6 stabilization)
### TeX-ready compression candidate
Updated default replacement candidate for possible `C300`:
...
## Entry 2026-02-14 (S277 Iteration 4 stabilization)
