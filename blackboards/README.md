...
| Slot | Topic | Status |
|------|-------|--------|
| 0 | TWO TOPICS. §§S1-S5: Heat kernel as bi-half-density literature scan (Melrose, Bates-Weinstein, Hormander-Duistermaat, Parker, Visser). Worked-example roadmap for HD-QFT paper. §§V1-V4: Velhinho 2017 better-refs search — Sudakov 1959 or Glimm-Jaffe 1987 as primary; Smolyanov-Montaldi 2017 constructive; Lackman 2024a-c groupoid composition; Bonanno-Falls-Ferrero 2025 diffeo-invariant measure. | ONE-AGENT (student R29). |
...
| 2 | Gangolli gap analysis: closing the all-k exponential proof. Killing factorization gives a_k = c_k(d) R^k but NOT c_k = 1/(6^k k!). Gangolli (1968) + Poisson summation proves all k at once. a_3 is first non-trivial case. Recommendation: cite Gangolli + Anker-Ostellari + FdV for rigorous proof. | ONE-AGENT (computationalist R29). Needs mathematician review. |
| 3 | Critic audit board (R28-R29). §§1-6: retraction audit. §7-§12: reviews. §13: D=4. §14: BB1. §15: P4.2 patch. §16: Duflo review (sev-3). §17: allk review. | Critic R28-R29. 12 items. |
