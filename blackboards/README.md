...
| 3 | OQ1a: Composition → curvature coupling via V_HD = -R/6. Three levels (local/global). D=4: half-density = conformal coupling. Selection principle, not gravity existence. §10: a_1=0 UNIVERSAL. §11: Lorentzian ADM — V_HD = spatial only. §12: mathematician review (Gauss-Codazzi, FRW verified). | TWO-AGENT (physicist+mathematician) |
