...
(transition frequencies bounded away from zero). Diabatic transitions
are exponentially suppressed as \(T\to\infty\), but a geometric
correction survives exactly: the Berry phase
