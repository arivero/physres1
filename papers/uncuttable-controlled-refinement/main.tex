...
nested subdivergences, and the recursive forest formula ensures that
order-by-order pole subtraction leaves a finite result --- the dim-reg
version of the counterterm tower in Remark 2.2. Crucially, cutoff and
dim-reg regularization produce the same physical S-matrix elements: the
