...
This cancellation is also conformal-class-specific: for a general metric, the conjugation potential is \(V=|\nabla\omega|^2_g - \Delta_g\omega\) with \(\omega=\tfrac{1}{4}\ln|g|\), and the partial cancellation at \(D=4\) relies on the conformal structure (contracted Christoffel symbols proportional to \(\partial\sigma\)).
