...
attractive static potential for same-sign scalar sources --- the sign
alternates with the spin of the exchanged particle (attractive for even
spin, repulsive for odd spin), a separate vertex-structure effect. The
spectral positivity holds equally for the leading spectral function of
the fermion propagator; the difference between bosonic and fermionic
cases is not the spectral weight's sign but the Grassmann nature of the
source terms (Section 3). The spectral representation also underlies the
dispersion relation of Remark 3.5: the once-subtracted dispersion
integral for \(\Pi(q^2)\) is the spectral decomposition of the photon
self-energy, with the spectral weight \(\mathrm{Im}\,\Pi(s)\) related to
production cross-sections via the optical theorem (Remark 3.6).
