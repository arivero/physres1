...
perturbation theory) is built entirely from bosonic meson fields.
Proving that pure Yang-Mills gauge theory in four dimensions has a mass
gap from first principles is one of the Clay Millennium Prize Problems;
lattice QCD provides numerical evidence for confinement and a mass gap,
