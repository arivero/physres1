...
\texttt{Proof.} Fix a nonneg mollifier
...
\tightlist
\item
  Extend the single-impulse model to a sequence of \(N\) impulses and
  take the continuum limit, recovering stochastic forcing or the
  path-integral time-slicing prescription.
\item
