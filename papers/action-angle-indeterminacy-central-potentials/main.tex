...
\texttt{Remark\ 6.8\ (Bargmann\ representation:\ action–angle\ duality\ made\ algebraic).}
...
ring-versus-blob distinction of Remarks 6.4--6.7 is literally monomials
...
functions, recovering the Bargmann representation of Remark 6.8 --- the
...
Remark 6.7, with the prequantization condition forcing
...
\item
  ...
  holomorphic representation; used in Remark 6.8.)
\item
  ...
  states including spin coherent states; used in Remark 6.7.)
\item
