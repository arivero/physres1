...
4. [Bargmann1961] Valentine Bargmann, "On a Hilbert space of analytic functions and an associated integral transform, Part I," *Communications on Pure and Applied Mathematics* 14 (1961), 187–214. DOI `10.1002/cpa.3160140303`. (Bargmann–Segal holomorphic representation; used in Remark 6.8.)
5. [Perelomov1972] A. M. Perelomov, "Coherent states for arbitrary Lie group," *Communications in Mathematical Physics* 26 (1972), 222–236. DOI `10.1007/BF01645091`. (Generalized coherent states including spin coherent states; used in Remark 6.7.)
