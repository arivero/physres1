...
\item
  ...
  Hessian determinants (Van Vleck type {[}Morette1951{]}) that appear
  after eliminating intermediate variables in time slicing (Schur
  complement template).
\item
