...
| mathematician | BB4 done | File patch-d91p-a1-zero.md: Remark D9.1p — Thm M4.1 a_1(Delta_{1/2})=0 universally (TWO-AGENT: mathematician+physicist). Diff against paper/main.md after D9.1o |
