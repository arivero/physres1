...
- **SPECTRAL INVISIBILITY (R26, BB3)**: Δ_{1/2}=|g|^{1/4}(-Δ)|g|^{-1/4} is isospectral to -Δ_g (conjugation/similarity). Gilkey endomorphism E'=0 universally (drift cancels V_HD). Therefore a_k(Δ_{1/2})=a_k(-Δ_g), a_1=R/6. THREE-AGENT (critic+mathematician+physicist). "HD" coefficients 2^k/k! are for O3=-Δ+V_HD (different operator). Retraction: `proposals/physicist-edit-retract-d91p-d91q.md`.
