...
- **P12.1 DCT dominating function (sev-3)**: K_0(x,y;t/2) is NOT a valid L^1 dominator (tails of K_eps are wider). Fix: use (4πt)^{-d/2}exp(-|x-y|²/(6t)). Conclusion correct, proof sketch wrong. (mathematician SINGLE-AGENT). Needs 2nd agent in R19.
