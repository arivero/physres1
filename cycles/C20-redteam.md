...
2. Mixing up the full U(2) family with the single-parameter Robin toy without labeling the truncation.
...
## Mitigations Used
- Labeled the Robin running explicitly as “engineering” (not loop-induced).
- Treated Robin as a toy truncation and kept the U(2) remark as context.
