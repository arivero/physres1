...
3. `[Dirac1933]` P. A. M. Dirac, "The Lagrangian in Quantum Mechanics," *Proceedings of the Cambridge Philosophical Society* 29 (1933), 69-72.
4. `[Feynman1948]` R. P. Feynman, "Space-Time Approach to Non-Relativistic Quantum Mechanics," *Reviews of Modern Physics* 20 (1948), 367-387.
5. `[Connes1994]` Alain Connes, *Noncommutative Geometry* (1994), foundational source for tangent-groupoid and deformation perspective.
6. `[Landsman1998]` N. P. Landsman, *Mathematical Topics Between Classical and Quantum Mechanics* (1998), deformation quantization and classical-limit framework.
7. `[ConnesKreimer2000]` Alain Connes and Dirk Kreimer, "Renormalization in quantum field theory and the Riemann-Hilbert problem I," *Communications in Mathematical Physics* 210 (2000), 249-273.
...
3. `[Dirac1933]`: no stable DOI recorded in current ledger entry; verify journal metadata before DOI insertion.
4. `[Feynman1948]`: DOI `10.1103/RevModPhys.20.367`.
5. `[Connes1994]`: monograph record in current use has no DOI in this ledger.
6. `[Landsman1998]`: monograph DOI is edition-dependent; not pinned yet in this ledger.
...
2. `[Rivero0603123]` Alejandro Rivero, "Some bounds extracted from a quantum of area," arXiv:`gr-qc/0603123` (v1, 30 Mar 2006). Local mirror file: `/usr/local/var/www/wordpress/research/0603123.pdf`.
3. `[Rivero9710026]` A. Rivero, "Introduction to the Tangent Grupoid," arXiv:`dg-ga/9710026` (23 Oct 1997). Local mirror file: `/usr/local/var/www/wordpress/research/9710026.pdf`.
4. `[Rivero9803035]` Alejandro Rivero, "A short derivation of Feynman formula," arXiv:`quant-ph/9803035` (14 Mar 1998). Local mirror file: `/usr/local/var/www/wordpress/research/9803035.pdf`.
5. `[Rivero0302285]` Alejandro Rivero, "Flashes of noncommutativity," arXiv:`math.QA/0302285` (v1, 24 Feb 2003). Local mirror file: `/usr/local/var/www/wordpress/research/0302285.pdf`.

## A. Rivero Local Notes
1. `[RiveroOde2002]` A. Rivero, "Revisiting the Tangent Groupoid" (Aug 8, 2002). Local mirror file: `/usr/local/var/www/wordpress/research/ode.pdf`.
2. `[RiveroSimple]` Alejandro Rivero, "Constraints on space-time dimensionality in the classical approximation" (undated note). Local mirror file: `/usr/local/var/www/wordpress/research/simple.pdf`.
3. `[RiveroAreal]` Alejandro Rivero, "On Planck Areal Speed" (letter; DOI `10.32388/Q7SKTZ`). Local mirror file: `/usr/local/var/www/wordpress/research/Areal.pdf`.
