...
5. `[Connes1994]`: `PENDING_LIBRARY` — book (Academic Press, 1994); not available via OA or sci-hub. Requires physical library visit.
6. `[Landsman1998]`: `PENDING_LIBRARY` — book (Springer, 1998); not available via OA or sci-hub. Requires physical library visit or institutional Springer access.
...
27. `[Groenewold1946ElementaryQM]`: `PENDING_LIBRARY` — not available on sci-hub CDN (DOI `10.1016/S0031-8914(46)80059-4`); ScienceDirect paywall. Requires institutional access or physical library.
