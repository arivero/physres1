...
universal candidate. The dependent note
\texttt{papers/planck-area/main.md} explores further (optional)
...
coupling-dimension sieve in \texttt{papers/planck-area/main.md}; for
details and an invariant derivation see
\texttt{papers/half-density-qft/main.md} and
\texttt{blackboards/2026-02-10-half-density-laplacian-conformal-rescaling-invariant.md}.
...
Vleck density'', see {[}deGosson2018ShortTimePropagators{]}. For an
explicit finite-dimensional quadratic-elimination template showing how
mixed endpoint Hessians arise via Schur complements (a time-slicing
analogue), see \texttt{paper/notes/van-vleck-schur-complement.md}.
...
structural RG discussion, 2. a consolidated diagram/figure summarizing
the refinement-compatibility chain for reader navigation, 3. a final
...
\section{10. Technical Appendices (Continuation
...
This appendix replaces the earlier continuation version with a
...
\subsection{10.4 Continuation Outcome}\label{continuation-outcome}
...
\item
  ...
  20 (1948), 367--387. DOI \texttt{10.1103/RevModPhys.20.367}.
\item
