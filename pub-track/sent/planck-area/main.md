...
11. [Ehrenfest1917DimensionThree] Paul Ehrenfest, "In what way does it become manifest in the fundamental laws of physics that space has three dimensions?" *Proceedings of the Amsterdam Academy* 20 (1918) 200–209. (Foundational argument: stable closed orbits under central forces require spatial dimension $n \leq 3$, selected by dynamical stability rather than dimensional analysis alone.)
12. [Tegmark1997Dimensionality] Max Tegmark, "On the Dimensionality of Spacetime," *Classical and Quantum Gravity* 14 (1997) L69–L75. arXiv:`gr-qc/9702052`. DOI `10.1088/0264-9381/14/5/002`. (Anthropic argument combining orbit stability + atomic binding + gravitational force + causal PDEs to select 3+1 dimensions uniquely.)
13. [Carlip2017Dimension] Steven Carlip, "Dimension and Dimensional Reduction in Quantum Gravity," *Universe* 5 (2019) 83. arXiv:`1705.05417`. (Comprehensive review: spectral dimension flows from $d_s \sim 4$ (IR) to $d_s \sim 2$ (UV) across independent quantum gravity approaches [CDT, Asymptotic Safety, LQG, Horava-Lifshitz gravity], suggesting structural connection to half-density composition exponent $d/2$.)
